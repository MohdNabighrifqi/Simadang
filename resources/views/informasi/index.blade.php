...
<div class="info-section" style="padding-top:3rem;">
    ...
    <div class="faq-grid" id="faqAccordion">
        ...
        <div class="faq-item">
            ...
            <div class="faq-answer"><div class="faq-answer-inner">Hubungi BPSPL Padang (Wil. Kepri) di bpspl.padang@kkp.go.id atau lihat direktori kontak lembaga konservasi di bagian bawah halaman ini.</div></div>
        </div>
        <div class="faq-item">
